...
export function RegistrationView(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('https://dashboard.heroku.com/apps/limitless-thicket-23479/users', {
            Username: username,
            Password: password,
            Email: email,
            Birthday: birthday
            ...
            <Form>
                <Form.Row>
                    ...
                    <Form.Group as={Col} className="col-12 col-sm-12 col-md-6" controlId="password" >
                        ...
                        <Form.Control type="password" placeholder="Enter your password" value={password} onChange={e => createPassword(e.target.value)} />
                    </Form.Group >
                </Form.Row>
                ...
                <Form.Row>
                    <Form.Group as={Col} className="col-12 col-sm-12 col-md-6" controlId="birthday">
                        ...
                        <Form.Control type="date" placeholder="13/05/2020" value={birthday} onChange={e => createBirthday(e.target.value)} />
                    </Form.Group>
